  ...
  <div>
    <el-dialog :title="info.title" :visible.sync="info.isShow">
      <el-form :model="form">
        ...
        >
          <div class="specBox">
            ...
            <el-button type="success" v-if="index === 0" @click="specAdd"
              >新增规格属性</el-button
            >
            <el-button type="danger" v-else @click="specDel(index)"
              >删除</el-button
            >
          </div>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="info.title == '规格添加'" type="primary" @click="add"
          >添 加</el-button
        >
    ...
    checked() {
      return new Promise((resolve, rejece) => {
        if (this.form.specsname == "") {
          alertWarning("请输入规格名称");
          return;
        }
        if (this.form.attrs == '[""]') {
          alertWarning("请填写商品规格");
          return;
        }
